...
class War(db.Model):
    ...
    _streak = db.Column(db.Integer, unique=False, nullable=False)
...
def initWar():
    with app.app_context():
        ...
        u1 = War(username="Mr. Cards", streak=3)
        u2 = War(username="Kard Kowntre", streak=4)
        u3 = War(username="Un Bea Table", streak=5)
